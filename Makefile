...
#    Updated: 2025/04/12 18:22:34 by malrifai         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BUILTINS	= builtins/echo.c builtins/unset.c builtins/export/export.c builtins/export/copy_env.c builtins/export/print_env.c builtins/pwd.c builtins/env.c builtins/env_utils.c builtins/cd.c
